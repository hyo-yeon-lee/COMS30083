...
# Task 11
def train_neural_network(X, y, hidden_layer_sizes=[32, 16], epochs=80, learning_rate=0.035, weight_decay=1e-4, clip_value=1.0):
...
def main():
    ...
    degree = 3
    linear_model, X_train_poly = train_linear_regression(X_train, y_train, 3)
